					...
					<div class="col-lg-4 col-md-5 col-sm-5">
						...
						<form id="store_shift_start_form"  class="store_shift hide" action="" method="post" accept-charset="utf-8" class="separate-sections form-horizontal" autocomplete="off">
							...
							<div class="input-group padded">
								...
								<input type="text" readonly="readonly" name="counter_no" value="<?php global $config; echo $config['till_no']; ?>" id="counter_no" class="input-sm form-control" placeholder="Counter Number" autocomplete="off"/>
							</div>
