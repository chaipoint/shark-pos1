...
<?php if(!@$error) {?>
<div class="padded" id="dashboard_div">
	<span class="padded">Message From the office for you</span>
	<div class="panel panel-info" style="min-height:80px;width:65%;margin-left:15px;background-color:#C8C8C8">
...
<?php } else {?>
<div class="alert alert-danger text-center" style="width:65%;min-height:450px"><?php echo INTERNET_ERROR;?></div>
<?php }?>
...
<div class="padded">
		...
		<button class="btn" id="caw_sync" data-store_id="<?php echo $_SESSION['user']['store']['id'];?>">Get Latest CAW Data</button>
