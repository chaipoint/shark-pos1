						...
						foreach($value['doc']['shift'] as $shKey => $shValue){
							if(array_key_exists($shValue['shift_no'], $shiftList)){ 
								$upsQuery = "UPDATE cp_pos_shift_data 
											 ...
											 cash_denomination= '10:".$shValue['cash_denomination']['qty_10'].",20:".$shValue['cash_denomination']['qty_20'].",50:".$shValue['cash_denomination']['qty_50'].",100:".$shValue['cash_denomination']['qty_100'].",500:".$shValue['cash_denomination']['qty_500'].",1000:".$shValue['cash_denomination']['qty_1000'].",sodex:".$shValue['cash_denomination']['qty_sodex'].",ticket_restaurent:".$shValue['cash_denomination']['qty_ticket_res']."'
								...
								$insertQuery .= "('".$dbList[$value['id']]['id']."','".$shValue['start_time']."','".$shValue['end_time']."','".$shValue['start_login_id']."','".$shValue['end_petty_cash']."','".$shValue['opening_cash_inbox']."','".$shValue['end_cash_inbox']."','".$shValue['counter_no']."','".$shValue['shift_no']."','".$shValue['petty_cash_balance']['opening_petty_cash']."', '".$shValue['petty_cash_balance']['petty_expense']."','".$shValue['petty_cash_balance']['closing_petty_cash']."','".$shValue['petty_cash_balance']['inward_petty_cash']."','10:".$shValue['cash_denomination']['qty_10'].",20:".$shValue['cash_denomination']['qty_20'].",50:".$shValue['cash_denomination']['qty_50'].",100:".$shValue['cash_denomination']['qty_100'].",500:".$shValue['cash_denomination']['qty_500'].",1000:".$shValue['cash_denomination']['qty_1000'].",sodex:".$shValue['cash_denomination']['qty_sodex'].",ticket_restaurent:".$shValue['cash_denomination']['qty_ticket_res']."')";								
								//echo $insertQuery;
