<style>
	...
	.print {width:70%}
	.generate-bill {width:70%;margin-top:5%;}
</style>
...
<div class="panel panel-info" style="width:80%"> 
	 ...
	 <div class="panel-body tabbable">
        <ul class="nav nav-pills" role="tablist" style="margin-top:-13px;">
		  <li class="<?php echo ($status == 'New' ? 'active' : '');?>"><a href="<?php echo URL;?>?dispatch=orders.olo&status=New">New&nbsp;&nbsp;<span id="New" class="" <?php echo ($order_count['New']!=0) ? 'style="color:red"' : ''; ?>><?php echo $order_count['New']; ?></span></a></li>
		  <li class="<?php echo ($status == 'Confirmed' ? 'active' : '');?>"><a href="<?php echo URL;?>?dispatch=orders.olo&status=Confirmed">Confirmed&nbsp;&nbsp;<span id="Confirmed" class="" <?php echo ($order_count['Confirmed']!=0) ? 'style="color:red"' : ''; ?>><?php echo $order_count['Confirmed']; ?></span></a></li>
		  <li class="<?php echo ($status == 'Cancelled' ? 'active' : '');?>"><a href="<?php echo URL;?>?dispatch=orders.olo&status=Cancelled">Cancelled&nbsp;&nbsp;<span id="Cancelled" class="" <?php echo ($order_count['Cancelled']!=0) ? 'style="color:red"' : ''; ?>><?php echo $order_count['Cancelled']; ?></span></a></li>
		  <li class="<?php echo ($status == 'Dispatched' ? 'active' : '');?>"><a href="<?php echo URL;?>?dispatch=orders.olo&status=Dispatched">Dispatched&nbsp;&nbsp;<span id="Dispatched" class="" <?php echo ($order_count['Dispatched']!=0) ? 'style="color:red"' : ''; ?>><?php echo $order_count['Dispatched']; ?></span></a></li>
		  <li class="<?php echo ($status == 'Delivered' ? 'active' : '');?>"><a href="<?php echo URL;?>?dispatch=orders.olo&status=Delivered">Delivered&nbsp;&nbsp;<span id="Delivered" class="" <?php echo ($order_count['Delivered']!=0) ? 'style="color:#1a1a1a"' : ''; ?>><?php echo $order_count['Delivered']; ?></span></a></li>
		  <li class="<?php echo ($status == 'Paid' ? 'active' : '');?>"><a href="<?php echo URL;?>?dispatch=orders.olo&status=Paid">Paid&nbsp;&nbsp;<span id="Paid" class="" <?php echo ($order_count['Paid']!=0) ? 'style="color:#1a1a1a"' : ''; ?>><?php echo $order_count['Paid']; ?></span></a></li>
	    </ul>
