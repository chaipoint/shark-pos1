...
define ('EXE_PATH', 'c:\inetpub\wwwroot\pos\utility');
define ('COMPANY_DETAIL_TXT_PATH', 'c:\inetpub\wwwroot\pos\utility\company.txt');
define ('BILL_DETAIL_TXT_PATH', 'c:\inetpub\wwwroot\pos\utility\bill.txt');
define ('CARD_SALE_TXT_PATH', 'c:\inetpub\wwwroot\pos\utility\card_sale.txt');
...
define ('INVALID_COUPON', 'Invalid Code!');
define ('NOT_FOUND', 'not_found');
define ('BILL_NOT_FOUND', 'Bill Not Found');
define ('LOCAL', 'L');
define ('CLOUD', 'C');
define ('FREEBIE', 'FREEBIE');
...
define ('STORE_AUDIT', 'storeAudit');
define ('VALID_INPUT_ERROR', 'Please Provide Valid Input Variable');
