	...
	if( count($docsData) >0 ){
		...
		foreach($itemList as $lKey => $lValue){
			...
			foreach($lValue as $pKey => $pValue){
				$productsArray[] = "(".$lastInsertID.",".$pValue['id'].",'".$pValue['name']."',".$pValue['categroy_id'].",'".$pValue['categroy_name']."',".$pValue['qty'].",".$pValue['price'].",".$pValue['tax'].",".$pValue['priceBT'].",".$pValue['discount'].",".$pValue['discountAmount'].",".$pValue['taxAbleAmount'].",".$pValue['taxAmount'].",".$pValue['totalAmount'].",".$pValue['netAmount'].")";
			}
