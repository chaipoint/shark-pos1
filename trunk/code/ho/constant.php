...
define ('PETTY_EXPENSE_DESIGN_DOCUMENT_VIEW_EXPENSE_NO_MYSQL_ID', 'expense_no_mysql_id');
define ('PETTY_EXPENSE_DESIGN_DOCUMENT_VIEW_INWARD_NO_MYSQL_ID', 'inward_no_mysql_id');
define ('LOGIN_DESIGN_DOCUMENT_VIEW_LOGIN_NO_MYSQL_ID', 'login_no_mysql_id');

/* Constant For Design Document Update */
define ('LOGIN_DESIGN_DOCUMENT_UPDATE_LOGIN_HISTORY', 'login_history');
define ('DESIGN_HO_DESIGN_DOCUMENT_UPDATE_INSERT_MYSQL_ID', 'insert_mysql_id');
...
define ('NO_DATA_AVAILABLE_ERROR', 'Sorry! No Data Available');
define ('DATA_UPLOADED', 'Data Uploaded Successfully');
